...
export declare class Auth {
    ...
    validateFormSubmission: ReturnType<typeof validateFormSubmissionFunction>;
    ...
    handleServerSession: ReturnType<typeof handleServerSessionFunction>;
    getUserFromAccessToken: (accessToken: string, fingerprintToken: string) => Promise<import("../types.js").User>;
}
