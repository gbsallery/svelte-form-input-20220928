import { AccessToken, EncryptedRefreshToken, FingerprintToken, } from "../utils/token.js";
...
export const validateFormSubmissionFunction = (context) => {
    const validateFormSubmission = async (request) => {
        ...
        const accessToken = new AccessToken(formData.get("_lucia")?.toString() || "", context);
