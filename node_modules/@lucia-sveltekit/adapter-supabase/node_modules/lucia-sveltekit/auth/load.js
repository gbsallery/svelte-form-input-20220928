...
import { AccessToken, createBlankCookies, EncryptedRefreshToken, FingerprintToken, } from "../utils/token.js";
import cookie from "cookie";
export const loadFunction = (context) => {
    const load = async ({ setHeaders, request }) => {
