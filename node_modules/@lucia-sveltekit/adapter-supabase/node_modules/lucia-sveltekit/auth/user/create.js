...
export const createUserFunction = (context) => {
    const createUser = async (authId, identifier, options) => {
        ...
        const refreshToken = await createRefreshToken(user.user_id, fingerprintToken.value, context);
        ...
        const accessToken = await createAccessToken(user, fingerprintToken.value, context);
